	...
	const extendedOrgFeatures = [
		{
			...
			description: "Visualize your organization's performance with interactive and customizable charts.",
			icon: ChartPie,
			image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
		},
		{
			name: "Workflow Management",
			description: "Design and implement custom workflows for various organizational processes.",
			icon: Workflow,
		...
		},
		{
			...
			description: "Automatically generate offer letters, LORs, and other important documents.",
			icon: FileSignature,
			...
			<main className="pt-16">
				...
				<section className="py-16 bg-white dark:bg-gray-800">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						<div className="mt-10">
							<dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-8 md:gap-y-10">
								{orgManagementFeatures.map((feature) => (
									<div key={feature.name} className="relative bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md">
										<dt>
											<div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">
												<feature.icon className="h-6 w-6" aria-hidden="true" />
											</div>
						...
						<div className="mt-20">
							<h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">Advanced Organization Management Features</h3>
							<div className="space-y-12">
								{extendedOrgFeatures.map((feature, index) => (
									<div key={feature.name} className={`flex flex-col lg:flex-row items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
										...
										<div className="lg:w-1/2 mt-6 lg:mt-0 lg:px-8">
											<div className="flex items-center mb-4">
												...
												<h4 className="text-xl font-bold text-gray-900 dark:text-white">{feature.name}</h4>
											</div>
